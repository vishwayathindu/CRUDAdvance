        ...
        <form action="UpdateServlet" method="post">
            ...
            <div class="form-wrapper">
                <input type="text" placeholder="Username" class="form-control" name="UserName"
                       value="<c:out value="${st.userName}"/>" required maxlength="255">
                <i class="zmdi zmdi-account"></i>
            </div>
            <div class="form-wrapper">
                <input type="text" placeholder="NIC" class="form-control" name="nic" value="<c:out value="${st.nic}"/>"
                       minlength="10" maxlength="12" pattern="^([0-9]{9}[x|X|v|V]|[0-9]{12})$" required>
                <i class="zmdi zmdi-card"></i>
            </div>
            <div class="form-wrapper">
                <input type="text" placeholder="Mobile Number" class="form-control" name="mobileNumber"
                       value="<c:out value="${st.mobileNumber}"/>" minlength="10" maxlength="12"
